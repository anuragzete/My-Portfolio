...
import LoadingSpinner from "../../shared/components/LoadingSpinner.jsx"; // adjust path if needed
...
const StatsSection = () => {
    ...
    const stats = [
        ...
        { label: "Open Source Contributions", value: githubContributions },
        { label: "Blog Reads", value: "150+" },
    ];
    ...
    return (
        <section className="w-full flex justify-center py-10 px-4">
            <div className="backdrop-blur-md bg-white/10 dark:bg-black/10 border border-white/20 dark:border-black/20 rounded-2xl shadow-xl p-6 md:p-10 flex flex-wrap justify-center gap-8 max-w-4xl">
                {stats.map((stat) => (
